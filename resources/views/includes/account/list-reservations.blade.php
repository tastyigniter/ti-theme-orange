            ...
            @foreach ($reservations as $reservation)
                <tr>
                    ...
                    <td>
                        <a
                            class="btn btn-light"
                            href="{{ page_url('account/reservations', ['reservationId' => $reservation->reservation_id, 'hash' => $reservation->hash]) }}"
                        ><i class="fa fa-receipt"></i>&nbsp;&nbsp;@lang('igniter.reservation::default.btn_view')</a>
                    </td>
                </tr>
            @endforeach
            </tbody>
