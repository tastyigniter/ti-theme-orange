---
title: main::reservation.text_heading
layout: default
            ...
            <div class="">
                <div class="content-wrap">
                    <form
                        ...
                        <p>
                            <?= $customerIsLogged
                                ? sprintf(lang('main::reservation.text_logout'), $reservation->first_name, site_url('account/logout'.$redirect))
                                : sprintf(lang('main::reservation.text_registered'), site_url('account/login'.$redirect)); ?>
                        </p>
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <div class="form-group">
                                    <input
                                        ...
                                        id="first-name"
                                        class="form-control"
                                        placeholder="<?= lang('main::reservation.label_first_name'); ?>"
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <div class="form-group">
                                    <input
                                        ...
                                        id="last-name"
                                        class="form-control"
                                        placeholder="<?= lang('main::reservation.label_last_name'); ?>"
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                <div class="form-group">
                                    <input
                                        ...
                                        id="email"
                                        class="form-control"
                                        placeholder="<?= lang('main::reservation.label_email'); ?>"
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                <div class="form-group">
                                    <input
                                        ...
                                        id="confirm-email"
                                        class="form-control"
                                        placeholder="<?= lang('main::reservation.label_confirm_email'); ?>"
                        ...
                        <div class="form-group">
                            <input
                                ...
                                id="telephone"
                                class="form-control"
                                placeholder="<?= lang('main::reservation.label_telephone'); ?>"
                        ...
                        <div class="form-group">
                                <textarea
                                    ...
                                    class="form-control"
                                    rows="2"
                                    placeholder="<?= lang('main::reservation.label_comment'); ?>"
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input
                                    ...
                                    name="captcha"
                                    class="form-control"
                                    placeholder="<?= lang('main::reservation.label_captcha'); ?>"/>
                            </div>
                        ...
                        <?php if ($showButtons) { ?>
                            <div class="row">
                                <div class="col-sm-4">
                                    ...
                                    ><?= lang('main::reservation.button_reservation'); ?></button>
                                </div>
                                <div class="col-sm-2">
                                    <a class="btn btn-default btn-lg text-muted"
                                       href="<?= site_url('reservation'); ?>"
                                    ><?= lang('main::reservation.button_find_again'); ?></a>
                                </div>
                            </div>
                        <?php } ?>
                    </form>
