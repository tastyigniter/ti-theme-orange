---
title: main::contact.text_tab_gallery
layout: default
permalink: /contact
---
<div id="page-content">
            ...
            <div class="">
                <div class="row">
                    ...
                    <div id="contactForm" class="col-md-7 center-block">
                        <h4 class="contact-title"><?= lang('main::contact.text_summary'); ?></h4>
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="form-group">
                                    <select name="subject" id="subject" class="form-control">
                                        <option value=""><?= lang('main::contact.text_select_subject'); ?></option>
                                ...
                                <div class="form-group">
                                    <input
                                        ...
                                        placeholder="<?= lang('main::contact.label_email'); ?>"/>
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="form-group">
                                    <input
                                        ...
                                        placeholder="<?= lang('main::contact.label_full_name'); ?>"/>
                                ...
                                <div class="form-group">
                                    <input
                                        ...
                                        placeholder="<?= lang('main::contact.label_telephone'); ?>"/>
                        ...
                        <div class="form-group">
                            <textarea
                                ...
                                class="form-control"
                                rows="5"
                                placeholder="<?= lang('main::contact.label_comment'); ?>"
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input
                                    ...
                                    name="captcha"
                                    class="form-control"
                                    placeholder="<?= lang('main::contact.label_captcha'); ?>"/>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12">
                                <div class="buttons">
                                    ...
                                    ><?= lang('main::contact.button_send'); ?></button>
                                </div>
                            </div>
                        </div>
                        <?= form_close(); ?>
                ...
                <div class="heading-section">
                    <h3><?= lang('main::contact.text_find_us'); ?></h3>
