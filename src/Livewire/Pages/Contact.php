...
{
    #[Rule('required|max:128', as: 'igniter.frontend::default.contact.text_select_subject')]
    public $subject;

    #[Rule('required|email:filter|max:96', as: 'igniter.frontend::default.contact.label_email')]
    public $email;

    #[Rule('required|min:2|max:255', as: 'igniter.frontend::default.contact.label_full_name')]
    public $fullName;

    #[Rule('required', as: 'igniter.frontend::default.contact.label_telephone')]
    public $telephone;

    #[Rule('max:1500', as: 'igniter.frontend::default.contact.label_comment')]
    public $comment;
    ...
    {
        return view('igniter-orange::livewire.pages.contact', [
