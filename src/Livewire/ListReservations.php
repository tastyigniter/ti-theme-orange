...
class ListReservations extends \Livewire\Component
{
    use WithPagination;
    ...
    {
        return view('igniter-orange::livewire.list-reservations', [
    ...
    public function onCancel()
    {
        ...
        if (!$this->showCancelButton($reservation)) {
            throw new ApplicationException(lang('igniter.reservation::default.alert_cancel_failed'));
        }
    ...
    {
        if (!$hashParam = request()->input($this->hashParamName)) {
            return null;
        }
